    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            addToast({
                ...
                message: err.response?.data?.message || 'Impossible de créer le compte. Veuillez vérifier vos informations.'
            });
    ...
    return (
        <div className="container d-flex justify-content-center align-items-center vh-100">
            <div className="card p-4 shadow" style={{ maxWidth: '400px', width: '100%', borderRadius: '20px' }}>
                ...
                <p className="text-center text-muted mb-4">Rejoignez notre communauté</p>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-3">
                        <label className="form-label">
                            <FaUser className="me-2" />Votre nom complet
                        </label>
                        <input 
                            type="text" 
                            name="nom" 
                ...
                <p className="text-center mt-3">
                    Vous avez déjà un compte ? <Link to="/connexion" className="text-primary">Se connecter</Link>
                </p>
            </div>
        </div>
    );
