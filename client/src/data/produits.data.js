export const produitsMock = [
    {
        ...
        description:
            "Chemise hawaïenne d'été pour hommes, avec imprimé de plantes tropicales, respirante, décontractée",
        status: 'Nouveau',
        isNew: true,
        variations: [
    ...
    },
    {
        ...
        description:
            "Nouveautés dames élégant couleur unie costumes ensemble pour femmes Blazer et pantalon ensemble costumes d'affaires pour les femmes.",
        status: 'Promo',
        isPromotion: true,
        variations: [
            { type: 'taille', options: ['S', 'M', 'L', 'XL'] },
    ...
    },
    {
        ...
        isPromotion: true,
        variations: [{ type: 'couleur', options: ['Rouge', 'Noir', 'Beige'] }],
        stock: 20,
    ...
    },
    {
        ...
        description:
            'Bracelet acier inoxydable, mouvement suisse précis, étanche 50m. Un classique intemporel.',
        status: null,
        variations: [{ type: 'couleur', options: ['Or', 'Noir', 'Beige'] }],
        stock: 15,
    ...
    },
    {
        ...
        description:
            "Short d'été décontracté en coton pour Homme, surdimensionné.",
        status: 'Nouveautés',
        variations: [
            { type: 'taille', options: ['S', 'M', 'L', 'XL'] },
            { type: 'couleur', options: ['blanc', 'Gris', 'Noir'] },
    ...
    },
    {
        ...
        description:
            'Robes de plage sans Manches Décontracté avec Poches Blanc Floral.',
        status: 'Nouveautés',
        variations: [
            { type: 'taille', options: ['S', 'M', 'L', 'XL'] },
            { type: 'couleur', options: ['blanc', 'Gris', 'Noir'] },
