...
export default function CommandeCard({ commande, onChangeStatut }) {
    if (!commande)
        return (
            <div className="alert alert-warning">Aucune donnée de commande</div>
        );
    ...
    const displayStatut = isValidStatut
        ? STATUTS[normalizedStatut]
        : `Inconnu (${commande.statut})`;
            ...
            <div className="card-content">
                ...
                <div className="card-footer">
                    <div className="total">
                        Total:{' '}
                        <span>
                            {commande.total?.toLocaleString('fr-FR')} XOF
                        </span>
                    </div>
                    ...
                    {onChangeStatut && (
                        <div className="statut-selector">
                            <label
                                htmlFor={`statut-select-${commande.id}`}
