                    ...
                    <SwiperSlide key={i}>
                        ...
                        <div className="slide-content">
                            <h2 className="slide-title">
                                Découvrez Nody - Élégance Moderne {i + 1}
                            </h2>
                            <p className="slide-text">
                                Des collections exclusives pour exprimer votre
                                style unique.
                                {i === 0 &&
                                    " Explorez notre ensemble en lain pour trouver de l'inspiration pour votre prochaine tenue."}
                                {i === 1 &&
                                    ' La qualité rencontre le design innovant.'}
                                {i === 2 &&
                                    " Votre garde-robe n'attend que ça !"}
                            </p>
                            <button className="btn btn-light slide-button">
